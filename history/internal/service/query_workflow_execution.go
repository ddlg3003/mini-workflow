...
func (s *historyService) QueryWorkflowExecution(ctx context.Context, req *pb.QueryWorkflowRequest) (*pb.QueryWorkflowResponse, error) {
	...
	return &pb.QueryWorkflowResponse{QueryResult: req.QueryArgs}, nil
}
